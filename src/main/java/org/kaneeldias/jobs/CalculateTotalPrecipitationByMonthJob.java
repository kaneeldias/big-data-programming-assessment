...
public class CalculateTotalPrecipitationByMonthJob extends WeatherDataJob {

    static final String OUTPUT_PATH = "total_precipitation_by_month_output";
    private final String inputPath;

    public CalculateTotalPrecipitationByMonthJob(String jobTimestamp, String inputPath) {
    ...
    public Job getJob() throws IOException {
        ...
        Job calculateTotalPrecipitationJob = Job.getInstance(conf, "Calculate Total Precipitation by Month");
    ...
    public static class TotalPrecipitationMapper extends Mapper<Object, Text, Text, FloatWritable> {
        ...
        public void map(Object key, Text value, Context context)
            ...
            context.write(yearMonth, precipitationValue);
        }
    }
